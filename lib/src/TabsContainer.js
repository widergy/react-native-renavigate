Object.defineProperty(exports,"__esModule",{value:true});var _extends=Object.assign||function(target){for(var i=1;i<arguments.length;i++){var source=arguments[i];for(var key in source){if(Object.prototype.hasOwnProperty.call(source,key)){target[key]=source[key];}}}return target;};var _jsxFileName='src/TabsContainer.js';var _createClass=function(){function defineProperties(target,props){for(var i=0;i<props.length;i++){var descriptor=props[i];descriptor.enumerable=descriptor.enumerable||false;descriptor.configurable=true;if("value"in descriptor)descriptor.writable=true;Object.defineProperty(target,descriptor.key,descriptor);}}return function(Constructor,protoProps,staticProps){if(protoProps)defineProperties(Constructor.prototype,protoProps);if(staticProps)defineProperties(Constructor,staticProps);return Constructor;};}();var _react=require('react');var _react2=_interopRequireDefault(_react);
...
page:this.props.activeTabIndex,__source:{fileName:_jsxFileName,lineNumber:60}}),
...
onDidFocus:this.afterPushView,__source:{fileName:_jsxFileName,lineNumber:79}}));
...
}}]);return TabsContainer;}(_react.Component);var _initialiseProps=function _initialiseProps(){var _this3=this;this.shouldHideTabBar=function(){var currentTab=_this3.props.tabs[_this3.props.activeTabIndex];var activeRoute=_this3.activeRoutes[_this3.props.activeTabIndex];return!_this3.props.alwaysShowTabBar&&(_this3.props.shouldHideTabBar||currentTab&&Array.isArray(currentTab.initialRoute)&&currentTab.initialRoute.indexOf(activeRoute)>0);};this.afterPushView=function(){console.log('aaa');if(_this3.shouldHideTabBar()){_this3.setState({hiddenPad:0});}};this.beforePopView=function(route,tabIndex){console.log('bbbb');if(!_this3.shouldHideTabBar()){_this3.setState({hiddenPad:_this3.props.hiddenPad||0});}_this3.activeRoutes[tabIndex]=route;_this3.setState({activeRoutes:_this3.activeRoutes});};this.renderTabBar=function(props){if(_this3.shouldHideTabBar()){return _react2.default.createElement(_reactNative.View,{style:{height:_this3.state.hiddenPad},__source:{fileName:_jsxFileName,lineNumber:48}});}if(_this3.props.tabsComponentProps.renderTabBar){return _this3.props.tabsComponentProps.renderTabBar(props);}return _react2.default.createElement(_reactNativeScrollableTabView.DefaultTabBar,_extends({},props,{__source:{fileName:_jsxFileName,lineNumber:55}}));};this.handleTabChanged=function(_ref){var i=_ref.i;if(_this3.props.tabsComponentProps.onChangeTab){_this3.props.tabsComponentProps.onChangeTab({i:i});}_this3.props.dispatch(_actions.actionCreators.tabChanged(i));};};
